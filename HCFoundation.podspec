...
iOS基础拓展（NSObject、NSData、NSString、NSData、UIColor、UIImage应有尽有），常用宏定义简单易用，高效开发首选！
  ...
  s.homepage         = 'https://github.com/haisens@163.com/HCFoundation'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'haisens@163.com' => '殷海超' }
  s.source           = { :git => 'https://github.com/haisens@163.com/HCFoundation.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '8.0'

  s.source_files = 'HCFoundation/Classes/**/*'
